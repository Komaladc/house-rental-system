				...
				<a href="property_details.php?adid=<?php echo $fAd['adId'];?>">
					<div class="property_box_content overflow">
						...
						<div class="property_box_text">
							...
							<p><i class="fa-solid fa-rupee-sign"></i>NPR <?php echo $fAd['adRent'];?>/<?php if($fAd['rentType'] == "mo"){echo"Month";} else{ echo"Week"; }
					...
					<a href="property_details.php?adid=<?php echo $sAd['adId'];?>">
						<div class="property_box_content overflow">
							...
							<div class="property_box_text">
								...
								<p><i class="fa-solid fa-rupee-sign"></i>NPR <?php echo $sAd['adRent'];?>/<?php if($sAd['rentType'] == "mo"){echo"Month";} else{ echo"Week"; };
				...
				<a href="property_details.php?adid=<?php echo $getad['adId'];?>">
					<div class="property_box_content overflow">
						...
						<div class="property_box_text">
							...
							<p><i class="fa-solid fa-rupee-sign"></i>NPR <?php echo $getad['adRent'];?>/<?php if($getad['rentType'] == "mo"){echo"Month";} else{ echo"Week"; }
