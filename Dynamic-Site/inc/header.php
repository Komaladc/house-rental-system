<?php
	...
	include_once 'helpers/NepalTime.php';

	// Set Nepal timezone for the entire application
	date_default_timezone_set('Asia/Kathmandu');

	spl_autoload_register(function($class){
		// Skip NepalTime as it's already included above
		if ($class === 'NepalTime') {
			return;
		}
...
<head>
	...
	<meta name="keywords" content="Nepal rental system, property finder, house booking, apartment rental">
	<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
	<meta name="author" content="College Project - Property Management System">
	<meta name="description" content="Modern property rental management system for Nepal - College Project">
	<title>
		...
		<div class="top_left col overflow">
			...
			<div class="top_header_list overflow">
				<ul>
					<li>
						<p>
							<i class="fa-solid fa-phone"></i><span>Phone: +977-1-4567890</span>
						</p>
					</li>
					<li>
						<p>
							<i class="fa-solid fa-envelope"></i>
							</i><span>Email: info@propertyfindernepal.com</span>
						</p>
					</li>
				</ul>
			</div>
