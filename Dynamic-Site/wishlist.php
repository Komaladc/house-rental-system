				...
				<a href="property_details.php?adid=<?php echo $wlist['adId'];?>">
					<div class="property_box_content overflow">
						...
						<div class="property_box_text">
							...
							<p><i class="fa-solid fa-rupee-sign"></i>NPR <?php echo $wlist['adRent'];?>/<?php if($wlist['rentType'] == "mo"){echo"Month";} else{ echo"Week"; };?><?php if(!empty($wlist['adNegotiable'])){ ?><span> (negotiable)</span><?php } ?></p>
						</div>
					</div>
				</a>
			</div>
