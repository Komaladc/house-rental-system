<?php
session_start();
include "../lib/        if ($db->update($updateVerification) && $db->update($updateUser)) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['approve_user'])) {
        ...
        $updateVerification = "UPDATE tbl_user_verification SET verification_status = 'approved', reviewed_at = NOW(), reviewed_by = " . Session::get("userId") . " WHERE verification_id = $verificationId";
    ...
    if (isset($_POST['reject_user'])) {
        ...
        $updateVerification = "UPDATE tbl_user_verification SET verification_status = 'rejected', reviewed_at = NOW(), reviewed_by = " . Session::get("userId") . ", admin_comments = '$rejectionReason' WHERE verification_id = $verificationId";
...
$recentQuery = "SELECT uv.*, u.firstName, u.lastName, u.userEmail, u.userLevel, a.firstName as admin_fname, a.lastName as admin_lname
               FROM tbl_user_verification uv 
               JOIN tbl_user u ON uv.user_id = u.userId 
               LEFT JOIN tbl_user a ON uv.reviewed_by = a.userId
                ...
                <table class="recent-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo date('M d, Y', strtotime($verification['reviewed_at'])); ?></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
