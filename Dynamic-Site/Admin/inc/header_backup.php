...
// Add TinyMCE Cloud Script with domain verification
echo '<script>
    window.tinymce_email = "komaladhikari166@gmail.com";
</script>';
echo '<script src="https://cdn.tiny.cloud/1/8gxv0b6vauc4k8zkmzyteq28bts42xd1vp9vuna6i2tk4nm3/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>';
```
