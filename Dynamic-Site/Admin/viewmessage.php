				...
				<div class="responsive_mcol_small user_profile">
					...
					?>	
						...
						<div class="msg_block_body overflow">
							...
							<div class="msg_field_box"><textarea style="width: 100%; min-height: 200px; padding: 15px; border: 2px solid #ddd; border-radius: 5px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5; resize: vertical;" readonly><?php echo strip_tags($notification['notfMsg']);?></textarea></div>
						</div>
					...
					?>	
						...
						<div class="msg_block_body overflow">
							<div class="msg_field_box"><p>message</p></div>
							<div class="msg_field_box"><textarea style="width: 100%; min-height: 200px; padding: 15px; border: 2px solid #ddd; border-radius: 5px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5; resize: vertical;" readonly><?php echo strip_tags($msg['msgText']);?></textarea></div>
						</div>
