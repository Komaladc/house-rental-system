				...
				?>
					...
					<div class="property_block_body overflow">
						...
						<div class="add_property_field">
							...
							<textarea name="addetails" id="addetails" style="width: 100%; min-height: 200px; padding: 15px; border: 2px solid #ddd; border-radius: 5px; font-family: Arial, sans-serif; font-size: 14px; line-height: 1.5; resize: vertical;" placeholder="Enter property description here... (Optional)"><?php echo strip_tags($ad['adDetails']);?></textarea>
						</div>
					</div>
				</div>
