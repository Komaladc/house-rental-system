				...
				<div class="admin_property_table small_display_table">
					...
					<?php
						...
						<tr>
							...
							<td width="12%"><p><i class="fa-solid fa-rupee-sign" style="position:relative;top:-.4em;"></i>NPR <?php echo (floatval($adlist['adRent']) + floatval($adlist['gasBill']) + floatval($adlist['electricBill']) + floatval($adlist['sCharge']));?>/<?php echo $adlist['rentType'];?></p></td>
